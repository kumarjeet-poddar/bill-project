...
export default function Home(){
    ...
    <div className="flex flex-col justify-center items-center w-screen h-screen gap-y-4">
       ...
       <Link to="/form/quotation/null"><button className="border bg-slate-700 hover:bg-slate-800 transition-all text-slate-100 py-3 px-4 rounded-lg w-40">Quotation Form</button></Link>
    </div>
    </>
}